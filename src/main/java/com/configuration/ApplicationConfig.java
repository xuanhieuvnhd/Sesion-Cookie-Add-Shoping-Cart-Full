...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/shopingcart?useUnicode=true&characterEncoding=utf8");
    ...
    public CommonsMultipartResolver getResolver() throws IOException {
        ...
        //Đặt kích thước tối đa cho phép (tính bằng byte) cho từng tệp riêng lẻ.
        resolver.setMaxUploadSizePerFile(5242880);//5MB

        //Bạn cũng có thể đặt các thuộc tính có sẵn khác.
